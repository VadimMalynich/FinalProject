...
import by.training.finalproject.service.hibernate.AdInfoServiceImpl;
...
public class AdInfoServiceImplTest {
    private final by.training.finalproject.service.hibernate.AdInfoServiceImpl service = new AdInfoServiceImpl();
