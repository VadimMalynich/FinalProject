...
Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <em
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="social-icons">
                        <ul>
                            <li><a href="https://vk.com/id184844735" target="_blank"><em class="fab fa-vk"></em></a></li>
                            <li><a href="https://www.youtube.com/channel/UC2lRq_wvRmGjsJeWhLXWTDw" target="_blank"><em class="fab fa-youtube"></em></a></li>
                            <li><a href="https://www.instagram.com/_malyvan_/" target="_blank"><em class="fab fa-instagram"></em></a></li>
                        </ul>
                    </div>
                </div>
            </div>
