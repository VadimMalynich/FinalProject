...
-- Filling support table
INSERT INTO `support` (`user_category`, `user_text`)
VALUES ('user', 'Как долго мое объявление может находиться на сайте?'),
       ('admin', 'Оно может находиться на сайте не более полугода или пока вы сами его не удалите.');